...
urlpatterns = [
    ...
    path('board/post/', post_list),
    path('board/post/<int:pk>/', post_detail),
    path('board/post/comment/', comment_list),
    path('board/post/comment/<int:pk>/', comment_detail),
    path('board/post/image/', image_list),
    path('board/post/image/<int:pk>/', image_detail),
    path('board/post/view', view_list),
    path('board/post/view/<int:pk>/', view_detail),
    path('board/post/like/', like_list),
    path('board/post/like/<int:pk>/', like_detail),
    path('layout/', layout_list),
    path('layout/<int:pk>/', layout_detail),
    path('user/', user_list),
    path('user/<int:pk>/', user_detail),
    path('role/', role_list),
    path('role/<int:pk>/', role_detail),
]
